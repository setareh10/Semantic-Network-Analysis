...
stc_total_F=[[0]*4 for k in range(6)] 
stc_total_M=[[0]*4 for k in range(6)] 
stc_total_O=[[0]*4 for k in range(6)] 
stc_total_SD=[[0]*4 for k in range(6)] 
stc_total_LD=[[0]*4 for k in range(6)] 
...
def SN_functional_connectivity_bands_runs_BL(i,method):           
    ...
    stc_F_file_name=os.path.expanduser('~') +'/semnet-project/json_files/connectivity/stc_'+method+'BL_F_bands_sub'+str(i)+'.json'
    stc_O_file_name=os.path.expanduser('~') +'/semnet-project/json_files/connectivity/stc_'+method+'BL_O_bands_sub'+str(i)+'.json'
    stc_M_file_name=os.path.expanduser('~') +'/semnet-project/json_files/connectivity/stc_'+method+'BL_M_bands_sub'+str(i)+'.json'
...
for s in sbj_ids:
    SN_functional_connectivity_bands_runs_BL(s,method)
